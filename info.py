...
API_ID = int(environ.get('API_ID', '29063208'))
API_HASH = environ.get('API_HASH', '3061134c3e7ebeca33fa05a9b25dc62f')
BOT_TOKEN = environ.get('BOT_TOKEN', '7800414777:AAGI2cZQQKJAmtTOpNPko0B6hfpbMMweFTw')
#---------------------------------------------------------------
#---------------------------------------------------------------
